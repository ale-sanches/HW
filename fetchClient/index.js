...
var FetchClient = /** @class */ (function () {
    ...
    FetchClient.prototype.request = function (method, url, body) {
    ...
    FetchClient.prototype.get = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.request('GET', url)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    FetchClient.prototype.post = function (url, body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.request('POST', url, body)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    FetchClient.prototype.delete = function (url) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.request('DELETE', url)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    FetchClient.prototype.patch = function (url, body) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.request('PATCH', url, body)];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
